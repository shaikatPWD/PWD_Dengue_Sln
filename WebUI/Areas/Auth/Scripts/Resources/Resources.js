$(document).ready(function () {
    $(function () {
        ...
        $("#jqGrid").jqGrid({
            ...
            //width:'auto',
            //width: '70%',
            caption: 'Resource/Equipments Records',
            emptyrecords: 'No Resource/Equipments Records are Available to Display',
            jsonReader: {
                root: "rows",
                page: "page",
                total: "total",
        ...
        jQuery("#jqGrid").jqGrid('navGrid', '#jqGridPager',
            ...
            },
            {
                ...
                recreateForm: true,
                msg: "Are you sure to delete this Resouce? ",
                afterComplete: function (response) {
                    Messager.ShowMessage(response.responseText);
                }
            },
